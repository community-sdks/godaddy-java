...
public final class GetTicketsRequest {
    ...
    public GetTicketsRequest(String type, Boolean closed, String sourceDomainOrIp, String target, String createdStart, String createdEnd, Long limit, Long offset) {
        this.type = type;
        this.closed = closed;
