...
public final class PurchasePrivacyRequest {
    public final String xShopperId;
    public final String domain;
    public final Map<String, Object> body;

    public PurchasePrivacyRequest() {
        this.xShopperId = null;
        this.domain = null;
        this.body = null;
    }

    public PurchasePrivacyRequest(String xShopperId, String domain, Map<String, Object> body) {
